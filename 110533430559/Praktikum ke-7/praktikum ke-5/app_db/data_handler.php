                ...
                if ($view){
                        ...
                        <form action="" method="post">
                                <table border="0" cellpadding="4" cellspacing="0">
                                        <tr>
                                                <td width="100">NIM*</td>
                                                <td><input type="text" name="nim" size="10" value="<?php echo $nim;?>" class="input-medium" /> </td>
                                        </tr>
                                        <tr>
                                                <td>Nama</td>
                                                <td><input type="text" name="nama" size="40" value="<?php echo $nama;?>" class="input-xlarge" /> </td>
                                        </tr>
                                        <tr>
                                                <td>Alamat</td>
                                                <td><input type="text" name="alamat" size="60" value="<?php echo $alamat;?>" class="input-xxlarge" /> </td>
                                        </tr>
                                        <tr>
                                                <td></td>
