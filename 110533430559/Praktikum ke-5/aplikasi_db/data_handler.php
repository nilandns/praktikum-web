...
<?php
/**
*Fungsi utama untuk mengangani pengolahan data
...
?>
						<tr class="<?php echo $bg; ?>">
                            ...
                            <td align="center">
                                ...
                                | <a href="<?php echo $root; ?>&amp;act=delete&amp;id=<?php echo $id; ?>">Delete</a> |
                            </td>
                        </tr>
<?php
						$i++;
...
*@param string root parameter menu
8@param integer id nim mahasiswa
*/
...
<?php
/**
*fungsi untuk mengahsilkan form penambahan/ pengubahan
*@param string root parameter menu
